...
func GetItemFromCart() gin.HandlerFunc {
	...
	return func (c *gin.Context)  {
		...
		filter_match := bson.D{primitive.E{Key:"$match", Value:bson.D{primitive.E{Key:"_id", Value:usert_id}}}}
...
func (app *Application) InstantBuy() gin.HandlerFunc {
	...
	return func(c *gin.Context) {
		...
		err = database.InsatantBuyer(ctx, app.prodCollection, app.userCollection, productID, userQueryID)
